...
class MyCallbacks : public BLECharacteristicCallbacks {  // Interface Read/Write Function to Return Data
  void onWrite(BLECharacteristic *pCharacteristic) {
    ...
    /* char* pch0;
    char* pch1;
    const char* test = input.c_str(); // CODE IS NOT CONVERTING STRING INTO TWO PARTS CORRECTLY
    // If delimiter found -> split into two parts
    pch0 = strtok((char*) test, " ");
    pch1 = strtok(NULL, " ");
    */
    if (pch1 == "na") {
      if (pch0 == "thermo") {
