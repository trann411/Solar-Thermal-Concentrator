...
double Accel_TiltAngle(Adafruit_MMA8451 mma, double MUX_Channel) {
  ...
  double angle = y;  // Change to gravity for tilt array
...
double Accel_ArrayTiltAngle(Adafruit_MMA8451 mma2, Adafruit_MMA8451 mma3, Adafruit_MMA8451 mma4) {
  ...
  double Aout = Accel_TiltAngle(mma2, 2); // Modified to put out acceleration instead of angle
  double Bout = Accel_TiltAngle(mma4, 4); // Modified to put out acceleration instead of angle
  double Cout = Accel_TiltAngle(mma3, 3); // Modified to put out acceleration instead of angle
